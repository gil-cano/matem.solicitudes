...
#Campos CE
        ...
        FloatField('cantidad_recomendada_pasaje_apoyo',
            searchable=1,
            required=1,
            default='0.0',
            widget=StringWidget(label='Recommended amount for transportation expenses (Institutional)',
        ...
        FloatField('cantidad_recomendada_viaticos_apoyo',
            searchable=1,
            required=1,
            default='0.0',
            widget=StringWidget(label='Recommended amount for travel allowences (Institutional)',
        ...
        FloatField('cantidad_recomendada_inscripcion_apoyo',
            searchable=1,
            required=1,
            default='0.0',
            widget=StringWidget(label='Recommended amount for registration (Institutional)',
...
#Campos CI
        ...
        FloatField('cantidad_consejo_pasaje_apoyo',
            searchable=1,
            required=1,
            default='0.0',
            widget=StringWidget(label='Approved amount for transportation expenses (Institutional)',
        ...
        FloatField('cantidad_consejo_viaticos_apoyo',
            searchable=1,
            required=1,
            default='0.0',
            widget=StringWidget(label='Approved amount for travel allowences (Institutional)',
        ...
        FloatField('cantidad_consejo_inscripcion_apoyo',
            searchable=1,
            required=1,
            default='0.0',
            widget=StringWidget(label='Approved amount for registration (Institutional)',
        ...
        FloatField('cantidad_autorizada_pasaje_apoyo',
            searchable=1,
            required=1,
            default='0.0',
            widget=StringWidget(label='Approved amount for transportation expenses',
        ...
        FloatField('cantidad_autorizada_viaticos_apoyo',
            searchable=1,
            required=1,
            default='0.0',
            widget=StringWidget(label='Approved amount for travel allowences',
        ...
        FloatField('cantidad_autorizada_inscripcion_apoyo',
            searchable=1,
            required=1,
            default='0.0',
            widget=StringWidget(label='Approved amount for registration',
