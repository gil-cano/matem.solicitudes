...
SolicitudBecarioSchema = BaseSchema + Schema((
    ComputedField(name='title',
        required=1,
        searchable=1,
        expression="((here.getOwner() and 'Solicitud (Becario) de %s por %s (%s, %s, %s)' % (here.getNombreOwner(), here.getTotal(), here.getCiudadPais(), here.getInstitucion(), here.getFechaDesde() )) or 'Nueva solicitud')",
        accessor='Title',
    ...
    LinesField('grado',
        ...
        widget=SelectionWidget(
            ...
            i18n_domain='plone',
            description='Specify the degree of the scholarship holder',
            description_msgid='help_grado',
        ),
    ...
    StringField('asesor',
        ...
        widget=SelectionWidget(
            ...
            i18n_domain='plone',
            description="Name of the advisor of the scholarship holder",
            description_msgid="help_asesor",
        ),
        write_permission="Solicitud: Modificar Solicitud",
    ),
    ...
    StringField('apoyo_extra',
        required=1,
        default='No',
        vocabulary=DisplayList((
                                ('No', 'No'), ('Si', 'Si')
                                )),
        widget=MasterSelectWidget(label='Extra support',
    ...
    StringField('apoyo_texto',
        searchable=1,
        required=0,
        default='',
        widget=TextAreaWidget(label='Detail the obtained support',
                              label_msgid='label_apoyo_texto',
                              i18n_domain='plone',
                              description='Enter the detail of the obtained support',
                              description_msgid='help_apoyo_texto'),
        write_permission="Solicitud: Modificar Solicitud",
    ),
    ...
    StringField('pasaje',
        ...
        StringField('viaticos_becario',
            ...
            widget=MasterSelectWidget(label='Travel allowances',
                                 label_msgid='label_viaticos_becario',
                                 i18n_domain='plone',
                                 description='Specify if daily expenses are requested. It is necessary to deliver deliver receipts for the total',
                                 description_msgid='help_viaticos_becario',
...
#Comentarios del asesor
        StringField('comentario_asesor',
            ...
            widget=TextAreaWidget(label='Comments by advisor in charge',
                                ...
                                i18n_domain='plone',
                                description="The advisor can add additional remarks for this request here. Any information written will be accessible to both scholarship holder and the reviewers.",
                                description_msgid='help_comentario_asesor',
                                tarifas=False),
            read_permission="Solicitud: Modificar Solicitud",
