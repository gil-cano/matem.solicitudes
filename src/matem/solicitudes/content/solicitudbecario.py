...
SolicitudBecarioSchema = BaseSchema + Schema((
    ComputedField(name='title',
        required=1,
        searchable=1,
        expression="((here.getOwner() and 'Solicitud (Becario) de %s por %s (%s en %s, %s, %s)' % (here.getNombreOwner(), here.getTotal(), here.getCiudadPais(), here.translate(here.getPais()).encode('utf-8'), here.getInstitucion(), here.getFechaDesde() )) or 'Nueva solicitud')",
        accessor='Title',
